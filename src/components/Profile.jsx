...
function Profile({handleSetting = null}) {
  ...
  return (
    <div className='relative flex items-center px-5 justify-between'>
        ...
        <button type='button' onClick={()=>setView(e=>!e)} className='cursor-pointer active:scale-90 transition-all duration-200 '>{isView?<RiCloseLargeLine size={20} />:<BiDotsVertical size={20}/>}</button> 
